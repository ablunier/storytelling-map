...
let arrayNum = v => Array.from(new Array(v));
...
const CanvasMap = (props) => {
    let object = {
        ...
        init() {
            ...
            Array.from(this.props.textContainer.querySelectorAll('img')).forEach(img => {
        ...
        updateScroll(scroll) {
            let sectionIndex = this.sectionsBounds.findIndex((curSection, i, sections) => {
        ...
        renderMap() {
            ...
            let drawPoint = (point, i) => {
                this.ctx.fillStyle = setByStatus(
                    i,
            ...
            let drawPoints = () => this.points.forEach(drawPoint);
            ...
            let drawLabels = () => this.points.forEach(drawLabel);
            ...
            let drawIcon = () => {
                ...
                this.ctx.translate(...canvasPos(trailTip.x, trailTip.y));
                ...
                this.ctx.drawImage(icon, -iconCenter.x, -iconCenter.y);
            ...
            let localToGlobal = (v) => mult(sub(v, cameraPos), zoom);
            ...
            let trailPos = interpolate(pos, trailSegment.start, trailSegment.end, (v) => clamp(v * 1.2));
            ...
            let canvasPos = (x, y) =>
                typeof x == 'object' ? canvasPos(x.x, x.y) : [(x - mapSlice.x) * zoom, (y - mapSlice.y) * zoom];
            ...
            let gradient = this.ctx.createLinearGradient(
                this.sectionsBounds[0].right,
                0,
                this.sectionsBounds[0].right + 200,
                0
            );
