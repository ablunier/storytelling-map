...
/***/ function(module, exports, __webpack_require__) {
	...
	var setCompositeOperation = function setCompositeOperation(ctx) {
	    var mode = arguments.length <= 1 || arguments[1] === undefined ? 'source-over' : arguments[1];
	    ...
	    var object = {
	        ...
	        get trailColor() {
	            if (typeof this.props != 'undefined') {
	                if (this.props.trailColor != null) {
	                    return this.props.trailColor;
	                }
	            }

	            if (this.trailPath == null) {
	                return '#ccc';
	            }
	        ...
	        /**
	         * Init function. Triggered from Component.appendTo(element)
	         */
	        init: function init() {
	            var _this = this;
	        ...
	        drawMapBuffer: function drawMapBuffer(ctx, pos, zoom) {
	            ...
	            drawCanvasSlice(ctx, map.map, Object.assign({}, offset, {
	        ...
	        getMapSliceAtPercent: function getMapSliceAtPercent(percent) {
	            ...
	            var height = this.state.height / zoom;
	        ...
	        getZoomAtPercent: function getZoomAtPercent(percent) {
	            ...
	            var getNumericAttr = function getNumericAttr(el, attr) {
	                var def = arguments.length <= 2 || arguments[2] === undefined ? 1 : arguments[2];
	        ...
	        renderMap: function renderMap() {
	            ...
	            var setByStatus = function setByStatus(i, past, present) {
	                var future = arguments.length <= 3 || arguments[3] === undefined ? null : arguments[3];
	            ...
	            var checkForBufferUpdate = function checkForBufferUpdate() {
	                ...
	                if (dx < _this4.mapBufferMargin / 3 && dy < _this4.mapBufferMargin / 3 && zoomDelta < 1 && !(zoom == optimalScale && _this4.mapBufferLast.zoom != optimalScale)) {
	                    return;
	                }
...
/***/ function(module, exports) {
	...
	var callIfFunction = function callIfFunction(thisObj, f) {
	    var ifNot = arguments.length <= 2 || arguments[2] === undefined ? undefined : arguments[2];
...
/***/ function(module, exports) {
	...
	function createCanvas(width, height) {
	    var dpiAware = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getPointAtPercent(path, percent) {
	    if (Array.isArray(path)) {
	        return path[Math.round((0, _math.clamp)(percent) * (path.length - 1))];
	    }
	...
	function getLengthAtPoint(path, point) {
	    var subdivisionsPerIteration = arguments.length <= 2 || arguments[2] === undefined ? 10 : arguments[2];
	...
	function subdividePath(path, subdivisions) {
	    var subdivideByDistance = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];

	    var length = getLength(path);

	    if (subdivideByDistance) {
	        subdivisions = length / subdivisions;
	    }
...
/***/ function(module, exports) {
	...
	function interpolate(v, min, max) {
	    var f = arguments.length <= 3 || arguments[3] === undefined ? null : arguments[3];
